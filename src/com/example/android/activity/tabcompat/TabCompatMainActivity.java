...
package com.example.android.activity.tabcompat;
...
public class TabCompatMainActivity extends TabCompatActivity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tabcompatmain);

        TabHelper tabHelper = getTabHelper();

        
        /**
         * 图片对于api-11+直接使用图片，对于api-11-使用的是selector
         */
