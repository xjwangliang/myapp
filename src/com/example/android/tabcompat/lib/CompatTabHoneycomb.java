...
public class CompatTabHoneycomb extends CompatTab implements ActionBar.TabListener {
     ...
     */
    ActionBar.Tab mTab;
    CompatTabListener mCallback;//将ActionBar.TabListener的事件传递给CompatTabListener（即CompatTabListener封装了ActionBar.TabListener）
    Fragment mFragment;//笔记：为什么使用android.support.v4.app.Fragment，而不是android.app.Fragment？
