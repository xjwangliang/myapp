...
import com.ex.adlayout.test.util.SystemUiHider;
...
public class Splash extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bannerAd = (AdLayout) findViewById(R.id.adlayout_banner);
		iconAd = (AdLayout) findViewById(R.id.adlayout_icon);
		popupAd = (AdLayout) findViewById(R.id.adlayout_popup);
